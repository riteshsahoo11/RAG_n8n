🚀**Overview**
    ...
    It is split into two seamless workflows: an automated data processing pipeline that ingests documents directly from Google Drive, 
    and a conversational AI agent powered by Google Gemini that retrieves and answers questions based on that data.
